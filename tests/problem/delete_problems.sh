...
testDeleteProblemsMissingPathArgument() {
  $cmd -- -m deleteProblems >/dev/null 2>&1
  ret_code=$?
  assertEquals "${RET_ARGS_VALIDATION}" "${ret_code}"
}

testDeleteProblemsMissingMethodArgument() {
...
testDeleteProblemsIncorrectPathArgument() {
  config_file="resources/mocks/fake.json"
  $cmd -- -p "${config_file}" -m deleteProblems >/dev/null 2>&1
  ret_code=$?
  assertEquals "${RET_ARGS_VALIDATION}" "${ret_code}"
}

testDeleteProblemsIncorrectMethodArgument() {
  config_file="resources/mocks/success/problem/valid_problem.json"
  $cmd -- -p "${config_file}" -m deleteProblemsFake >/dev/null 2>&1
  ret_code=$?
  assertEquals "${RET_ARGS_VALIDATION}" "${ret_code}"
}

testDeleteProblemsMissingConfigData() {
...
testDeleteProblemsMissingBocaUrl() {
...
testDeleteProblemsMissingResultFilePath() {
...
testDeleteProblemsInvalidBocaUrl() {
...
testDeleteProblemsInvalidResultFilePath() {
...
testDeleteProblemsIncorrectBocaUrl() {
...
testDeleteProblemsIncorrectResultFilePath() {
...
testDeleteProblemsMissingLoginData() {
...
testDeleteProblemsMissingUsername() {
...
testDeleteProblemsMissingPassword() {
...
testDeleteProblemsInvalidUsername() {
...
testDeleteProblemsInvalidPassword() {
...
testDeleteProblemsIncorrectUsername() {
...
testDeleteProblemsIncorrectPassword() {
...
testDeleteProblemsMissingProblemData() {
  config_file="resources/mocks/fail/problem/missing_problem.json"
  testDeleteValidProblems "${config_file}"
}

testDeleteValidProblems() {
  if [ -n "$1" ]; then
    config_file="$1"
  else
    config_file="resources/mocks/success/problem/valid_problem.json"
