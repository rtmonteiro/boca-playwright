...
await page.locator("input[name='langnumber']")
.fill(language.id.toString());
await page.locator("input[name='langname']")
  .fill(language.name);
await page.locator("input[name='langextension']")
  .fill(language.extension);
